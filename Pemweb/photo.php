...
<html lang="en">
  <head>
    ...
    <title>Photo &#8211; Kejari Bangkalan</title>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #00cc00 ;">
                <a class="dropdown-item active" href="photo.php">Photo</a>
                <div class="dropdown-divider"></div>                
              ...
              <div id="breadcrumbs">
                <span class="">
                  ...
                  <span class="breadcrumb_last_link">
                    <a href="photo.html"><font color="grey">Foto</font></a>
              </div>                            
        </div><br>
          ...
          <!--isi foto-->
              ...
              <div class="container">
                <div class="row justify-content-center">
                  ...
                  <img class="alignnone  wp-image-583" src="../control/img/<?php echo $post['foto']; ?>" alt="" width="338" height="225"  sizes="(max-width: 338px) 100vw, 338px" /> 
